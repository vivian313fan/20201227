...
<body>
    <h2>新增佈告</h2> //H2代表副標題
    <form action="bulletin_add.php" method="post">	 //表單FROM是 action= 'bulletin_edit.php'，這代表當網友按下送出表單之後，會將資料傳送到 bulletin_add.php 這程式
    佈告內容：<p>
	<textarea rows="20" cols="100" name="content"></textarea>  
	     //打在<TITLE></TITLE>這裡面的文字會出現在瀏覽器視窗最上頭藍色部份裡，當作一篇網頁的主題。
    <p>
...
//TEXTAREA在表單中，建立一個可以輸入多行文字的輸入框。rows設定輸入框的高度、cols設定輸入框的寬度、name: 聲明欄位名稱
